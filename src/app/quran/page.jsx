    ...
    return (
        <>
            ...
            <div className="grid lg:grid-cols-6 gap-4 justify-center">
                <div className="card bg-base-200 mb-5 rounded-lg mt-5 p-2 shadow-xl col-start-2 col-span-4">
                            ...
                            <Link key={ i } href={ `/quran-detail/${item.nomor}` }>
                                <div className="card bg-base-200 shadow-xl text-center">
                                    <div className="card-body">
                                        ...
                                        <p >{ item.namaLatin }<span> <i>({ item.arti })</i></span></p>

                                    </div>
                                </div>
                            </Link>
                        )) :
                        <div className="card col-start-2 bg-base-200 shadow-xl text-center">
                            <div className="card-body">
                                <h2 className="card-title justify-center ">Maaf...</h2>
                                <p >Surat yang Anda cari tidak ada.</p>
